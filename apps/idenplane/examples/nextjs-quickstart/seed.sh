#!/bin/sh
# One-shot seed job: creates the demo realm, an OIDC client for this
...
echo "Seeding client 'nextjs-quickstart'..."
post "/quickstart/clients" '{
  "clientId": "nextjs-quickstart",
  "name": "Next.js Quickstart",
  "publicClient": true,
  "enabled": true,
...
echo "Seed complete. Realm: quickstart | Client: nextjs-quickstart | Demo user: demo / Demo1234!"
